...
- **R.05 — Two PD image human-clicks: RULED by Marco, 2026-07-07.** NARA 555751 is the **Manhattan Bridge** (NYC subways have never run over the Brooklyn Bridge; the catalog's title field was right, its caption field was wrong) — identity resolved, rights already Unrestricted, **clear to ship in the next imagery pass**. LOC Fulton St El 1914 is **rejected** — "the Fulton Street photo is ancient... I don't think we'll be needing it"; that property's imagery search restarts from zero. See the vault ledger (`pd-image-ledger-site.md` §6.2/§6.4) for full detail.
