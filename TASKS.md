...
- [ ] [p11] [requires-gui] Marco reads the nine hero lines on staging (`/work/<slug>`), both modes, phone. Edit in Payload → Projects → Hero line; mirror to `properties/<slug>.md` `h1:`.
