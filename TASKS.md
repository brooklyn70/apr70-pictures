...
- [ ] [p11] [requires-gui] **Reshape brief for the depth hero:** Marco answers the five questions in the no-go decision (reference, plates, chrome, scope). Then the agent shows a motion sketch BEFORE building. The original spec line is kept below for the record.
