...
| + | La Dolce Vita | Marcello's look | **He has one**, created in Gemini and Grok: the cast portrait, navy pinstripe with red stripe, red paisley tie, cigarette, wet dark hair, sun on the face | ref `11-00-property-images/ldv-43-l-a-dolce-vita-marcello-2-v01.png`; its webp twin (`ldv-49-marcello-v01.webp`, the manifest's "current cast ref") is in `_trash`, restore if preferred |
