...
export const Media: CollectionConfig = {
  ...
  fields: [
    ...
    {
      // The AI Mark, stored (v14 / i18n groundwork). Before this flag the site
      // decided a frame was AI-generated by matching the English phrase
      // "AI-generated" in its caption or credit line — a rule that breaks the
      // moment a caption is written in Portuguese. The disclosure is a fact
      // about the picture, not about the language of its caption, so it lives
      // here, once, un-localized.
      name: 'aiFrame',
      type: 'checkbox',
      label: 'AI-generated frame (AI Mark)',
      defaultValue: false,
      admin: {
        position: 'sidebar',
        description:
          'Tick when this frame was generated by AI. Drives the on-site AI disclosure stamp (Site Settings → AI Mark) in every language, replacing detection by the English phrase "AI-generated" in the caption. Archival photographs and real production stills stay unticked.',
      },
    },
    {
      name: 'frameRatio',
