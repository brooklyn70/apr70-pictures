...
- [ ] [p11] [claude] **True parallax scrolling study + recreation:** layers translate at different rates as the page scrolls, no pin, no zoom. Research filed in docs/handoff; eight reference sites re-studied; recreate the useful example as an original build. Marco sets the goal 2026-09-03 morning.
