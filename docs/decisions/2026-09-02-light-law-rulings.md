...
- **Marcello:** found. A full Grok portrait prompt (`310-dolce-vita/09-visuals/grok-imagine-website-prompts-2026-06-12.md:88`) and Gemini-locked master references (`marcello-di-bari-master-01/02.jpg`, frontal, side, full-body) exist from June 2026; the Gemini lock note says to use the master as `@image1` for all Marcello stills. The masters are on the NAS at `SharedData/00-01-vault-media/_vault-archive/2026-09-01-vault-media/09-visuals/310-dolce-vita/09z-moodboard/09z1-masters/`. The pinstripe portrait in the flat folder (`ldv-43-...marcello-2-v01.png`) is a different, younger face from an earlier render and is superseded.
