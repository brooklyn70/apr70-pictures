...
- [ ] [p4] [nas-shell] NAS Hop 1 — Build and start v3 stack. SHELL: cd /volume1/apps/apr70-pictures && sudo /usr/local/bin/docker compose -p apr70v3 up -d --build 2>&1 && sleep 30 && sudo /usr/local/bin/docker compose -p apr70v3 ps && sudo /usr/local/bin/docker compose -p apr70v3 logs cms --tail 30
